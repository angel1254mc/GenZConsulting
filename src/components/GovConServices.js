  ...
  return (
    <div className="flex flex-col w-full xl:px-20 md:px-10 mb-16 mt-8 md:my-16 items-center">
        ...
        <div className="flex flex-col sm:w-full md:w-6/12 gap-y-6 sm:gap-y-4 md:gap-y-1">
                ...
                <p className="text-sm xl:text-base 2xl:text-lg xl:mt-6 max-w-[1300px] md:text-sm text-gray-800 font-regular">Our Financial Management Services provide businesses with the tools and insights needed to make informed decisions and ensure financial stability. Our services include:</p>
